...
recv_frame_err:
        ...
        if(new_frame){
            ...
            /*dist2impact=crash_det.EstimateDistAndRange_BP(nav_tray,time2impact,10,0.4);

            time2impact=time2impact;
            dist2impact=dist2impact;

            if(crash_det.int_num==0){
                dist2impact=0;
                time2impact=0;
            }*/
        ...
        for(int i=0;i<net_kln;i++){
            net_kl[i].rho/=KFixer;
            net_kl[i].s_rho/=KFixer;
        }
